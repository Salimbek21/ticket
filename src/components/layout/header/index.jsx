          ...
          >
            ...
            <ul className={cls.nav_list_mobile}>
              ...
              <li className={cls.nav_item_mobile}>
                <Link className={cls.nav_link_mobile} href="/#cinemas" onClick={closeMenu}>
                  Кинотеатры
                </Link>
              </li>
            </ul>
            <div className={cls.user_definite_mobile}>
              {accountData.data == "" ? (
                <button className={cls.btn_login_mobile} onClick={handleOpenModal}>
                  <User />
                  <span>Войти</span>
                </button>
              ) : (
                <button className={cls.registeredUserMobile} onClick={goAccount}>
                  <span>{accountData?.data?.name}</span>
                  {accountData?.data?.picturePath == "" ? (
                    <User />
                  ) : (
